...
**Status:** Fase 3 EM EXECUÇÃO — 7/N tasks concluídas
...
- **Painel Operacional**: seção "Automações de hoje" com 4 cards — prints artifacts/t306_automacoes_painel.png e artifacts/t306_teste_humano_painel.png.
- Provas: RED/GREEN por API + regressão comercial confirmada. Evidências em evidencias/spec-3-005/. QA verde v0.0.443–0.0.448.

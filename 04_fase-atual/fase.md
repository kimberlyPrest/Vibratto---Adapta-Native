...
| 10 | T7.2 | Validar bordas, segurança, reversão e evidências — Kanban e movimentação acessível | Verificador da entrega | SPEC-1-007 | Erros, limites, rollback e índice de evidências da SPEC-1-007 passam | REFACTOR/REGRESSÃO + checklist completo | evidencias/spec-1-007/t7.2-regressao.md | T7.1 concluída | ☐ Planejada |
...
| 8 | T10.2 | Validar bordas, segurança, reversão e evidências — Trilha de auditoria append-only | Verificador da entrega | SPEC-1-010 | Erros, limites, rollback e índice de evidências da SPEC-1-010 passam | REFACTOR/REGRESSÃO + checklist completo | evidencias/spec-1-010/t10.2-regressao.md | T10.1 concluída | ☐ Planejada |
